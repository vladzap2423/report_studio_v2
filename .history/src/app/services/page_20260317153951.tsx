...
export default function ServicesPage() {
  ...
  return (
    <div className="p-6 max-w-screen-2xl mx-100">
      ...
      {/* Заголовок таблицы */}
      <div className="grid grid-cols-[120px_435px_120px_435px_100px_200px] gap-2 bg-gray-50/90 border border-gray-200 rounded-t-lg px-2 py-1 font-medium text-gray-600">
        <div>Код прайса</div>
          ...
          {rowVirtualizer.getVirtualItems().map((virtualRow: VirtualItem) => {
            ...
            return (
              <div
                ...
                className="grid grid-cols-[120px_435px_120px_435px_100px_200px] gap-2 bg-gray-50/70 border-b border-gray-200 items-center px-2 hover:bg-gray-50"
              >
                <input
