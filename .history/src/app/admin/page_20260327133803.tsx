...
export default function AdminPage() {
  ...
  return (
    <main className="flex h-full w-full gap-4 py-3">
      <aside className="h-full w-64 shrink-0 rounded-2xl border border-slate-200/80 bg-white/50 p-3 backdrop-blur-sm">
      ...
      <section className="h-full min-h-0 flex-1 rounded-2xl border border-slate-200/80 bg-white/85 backdrop-blur-sm">
