...
export default function ServicesAdminPanel() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col p-4">
      ...
      <div className="grid grid-cols-[180px_560px_120px_260px] gap-2 rounded-t-lg border border-gray-200 bg-gray-50/90 px-2 py-1 font-medium text-gray-600">
        <div>Код услуги</div>
          ...
          {rowVirtualizer.getVirtualItems().map((virtualRow: VirtualItem) => {
            ...
            return (
              <div
                ...
                className="grid grid-cols-[180px_560px_120px_260px] items-center gap-2 border-b border-gray-200 bg-gray-50/70 px-2 hover:bg-gray-50"
              >
                <input
